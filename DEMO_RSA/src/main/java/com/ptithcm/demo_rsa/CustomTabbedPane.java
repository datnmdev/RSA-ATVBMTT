...
public class CustomTabbedPane extends JTabbedPane {
    ...
    public void addTab(String title, Component component) {
        ...
        closeButton.setIcon(new ImageIcon(getClass().getResource("/img/close.png")));
        closeButton.setRolloverIcon(new ImageIcon(getClass().getResource("/img/close-hover.png")));
